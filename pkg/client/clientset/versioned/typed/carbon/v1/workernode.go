...
// WorkerNodesGetter has a method to return a WorkerNodeInterface.
...
// workerNodes implements WorkerNodeInterface
type workerNodes struct {
	client rest.Interface
	ns     string
}

// newWorkerNodes returns a WorkerNodes
func newWorkerNodes(c *CarbonV1Client, namespace string) *workerNodes {
	return &workerNodes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *workerNodes) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.WorkerNode, err error) {
...
func (c *workerNodes) List(ctx context.Context, opts metav1.ListOptions) (result *v1.WorkerNodeList, err error) {
...
func (c *workerNodes) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *workerNodes) Create(ctx context.Context, workerNode *v1.WorkerNode, opts metav1.CreateOptions) (result *v1.WorkerNode, err error) {
	result = &v1.WorkerNode{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("workernodes").
...
func (c *workerNodes) Update(ctx context.Context, workerNode *v1.WorkerNode, opts metav1.UpdateOptions) (result *v1.WorkerNode, err error) {
	result = &v1.WorkerNode{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workernodes").
...
func (c *workerNodes) UpdateStatus(ctx context.Context, workerNode *v1.WorkerNode, opts metav1.UpdateOptions) (result *v1.WorkerNode, err error) {
	result = &v1.WorkerNode{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workernodes").
...
func (c *workerNodes) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *workerNodes) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *workerNodes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.WorkerNode, err error) {
	result = &v1.WorkerNode{}
