...
// ServicePublishersGetter has a method to return a ServicePublisherInterface.
...
// servicePublishers implements ServicePublisherInterface
type servicePublishers struct {
	client rest.Interface
	ns     string
}

// newServicePublishers returns a ServicePublishers
func newServicePublishers(c *CarbonV1Client, namespace string) *servicePublishers {
...
func (c *servicePublishers) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ServicePublisher, err error) {
	result = &v1.ServicePublisher{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicepublishers").
		Name(name).
...
func (c *servicePublishers) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ServicePublisherList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ServicePublisherList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicepublishers").
...
func (c *servicePublishers) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *servicePublishers) Create(ctx context.Context, servicePublisher *v1.ServicePublisher, opts metav1.CreateOptions) (result *v1.ServicePublisher, err error) {
	result = &v1.ServicePublisher{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicepublishers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(servicePublisher).
		Do(ctx).
		Into(result)
	return
}
...
func (c *servicePublishers) Update(ctx context.Context, servicePublisher *v1.ServicePublisher, opts metav1.UpdateOptions) (result *v1.ServicePublisher, err error) {
	result = &v1.ServicePublisher{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicepublishers").
		Name(servicePublisher.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(servicePublisher).
		Do(ctx).
		Into(result)
...
func (c *servicePublishers) UpdateStatus(ctx context.Context, servicePublisher *v1.ServicePublisher, opts metav1.UpdateOptions) (result *v1.ServicePublisher, err error) {
	result = &v1.ServicePublisher{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicepublishers").
...
func (c *servicePublishers) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *servicePublishers) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *servicePublishers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ServicePublisher, err error) {
	result = &v1.ServicePublisher{}
