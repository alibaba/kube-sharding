...
// RollingSetsGetter has a method to return a RollingSetInterface.
...
func newRollingSets(c *CarbonV1Client, namespace string) *rollingSets {
	return &rollingSets{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *rollingSets) Create(ctx context.Context, rollingSet *v1.RollingSet, opts metav1.CreateOptions) (result *v1.RollingSet, err error) {
	result = &v1.RollingSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("rollingsets").
...
func (c *rollingSets) Update(ctx context.Context, rollingSet *v1.RollingSet, opts metav1.UpdateOptions) (result *v1.RollingSet, err error) {
	result = &v1.RollingSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rollingsets").
		Name(rollingSet.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(rollingSet).
		Do(ctx).
		Into(result)
...
func (c *rollingSets) UpdateStatus(ctx context.Context, rollingSet *v1.RollingSet, opts metav1.UpdateOptions) (result *v1.RollingSet, err error) {
	result = &v1.RollingSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rollingsets").
...
func (c *rollingSets) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *rollingSets) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
