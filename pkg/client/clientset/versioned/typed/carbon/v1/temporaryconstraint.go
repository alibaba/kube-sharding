...
// TemporaryConstraintsGetter has a method to return a TemporaryConstraintInterface.
...
// temporaryConstraints implements TemporaryConstraintInterface
type temporaryConstraints struct {
	client rest.Interface
	ns     string
}

// newTemporaryConstraints returns a TemporaryConstraints
func newTemporaryConstraints(c *CarbonV1Client, namespace string) *temporaryConstraints {
...
func (c *temporaryConstraints) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.TemporaryConstraint, err error) {
	result = &v1.TemporaryConstraint{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("temporaryconstraints").
		Name(name).
...
func (c *temporaryConstraints) List(ctx context.Context, opts metav1.ListOptions) (result *v1.TemporaryConstraintList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.TemporaryConstraintList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("temporaryconstraints").
...
func (c *temporaryConstraints) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *temporaryConstraints) Create(ctx context.Context, temporaryConstraint *v1.TemporaryConstraint, opts metav1.CreateOptions) (result *v1.TemporaryConstraint, err error) {
	result = &v1.TemporaryConstraint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("temporaryconstraints").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(temporaryConstraint).
		Do(ctx).
		Into(result)
	return
}
...
func (c *temporaryConstraints) Update(ctx context.Context, temporaryConstraint *v1.TemporaryConstraint, opts metav1.UpdateOptions) (result *v1.TemporaryConstraint, err error) {
	result = &v1.TemporaryConstraint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("temporaryconstraints").
		Name(temporaryConstraint.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(temporaryConstraint).
		Do(ctx).
		Into(result)
...
func (c *temporaryConstraints) UpdateStatus(ctx context.Context, temporaryConstraint *v1.TemporaryConstraint, opts metav1.UpdateOptions) (result *v1.TemporaryConstraint, err error) {
	result = &v1.TemporaryConstraint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("temporaryconstraints").
...
func (c *temporaryConstraints) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *temporaryConstraints) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *temporaryConstraints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.TemporaryConstraint, err error) {
	result = &v1.TemporaryConstraint{}
