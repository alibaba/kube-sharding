...
type Clientset struct {
	*discovery.DiscoveryClient
	carbonV1 *carbonv1.CarbonV1Client
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.carbonV1, err = carbonv1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.carbonV1 = carbonv1.NewForConfigOrDie(c)
